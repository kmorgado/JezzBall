...
static public class NGUIMenu
{
	...
	//[MenuItem("Assets/Create/NGUI", false, 10000)]
	...
	[MenuItem("Assets/Create/NGUI/Create 2D UI", false, 10001)]
	...
	[MenuItem("Assets/Create/NGUI/Create 2D UI", true, 10002)]
	static bool Create2Da() { return UIRoot.list.Count == 0; }

	[MenuItem("NGUI/Create/3D UI", false, 6)]
	[MenuItem("Assets/Create/NGUI/Create 3D UI", false, 10003)]
	...
	[MenuItem("Assets/Create/NGUI/Create 3D UI", true, 10004)]
